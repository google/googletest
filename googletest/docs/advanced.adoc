...
alphanumeric characters. In particular, they https://github.com/google/googletest/blob/master/googletest/docs/faq.adoc#why-should-test-case-names-and-test-names-not-contain-underscore[should not contain
underscores].
