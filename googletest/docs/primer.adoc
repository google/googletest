...
gMock link:../../googlemock/docs/CookBook.adoc#teaching-google-mock-how-to-print-your-values[recipe].).
...
typed while `NULL` is not. See link:faq.adoc#why-does-googletest-support-expect_eqnull-ptr-and-assert_eqnull-ptr-but-not-expect_nenull-ptr-and-assert_nenull-ptr[FAQ]
for more details.

If you're working with floating point numbers, you may want to use the floating
point variations of some of these macros in order to avoid problems caused by
rounding. See link:advanced.adoc[Advanced googletest Topics] for details.
...
https://github.com/google/googletest/blob/master/googletest/docs/advanced.adoc[this]
...
this link:faq.adoc#should-i-use-the-constructordestructor-of-the-test-fixture-or-setupteardown[FAQ] entry.
...
once conflicts with some advanced googletest features (e.g. thread-safe link:advanced.adoc#death-tests[death
...
link:advanced.adoc[AdvancedGuide]. You *must* call this function before calling
