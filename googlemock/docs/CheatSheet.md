...
The typical flow is:
  ...
  1. Exercise code that uses the mock objects; if necessary, check the result using [Google Test](https://github.com/google/googletest) assertions.
...
[Google Test](https://github.com/google/googletest)). They
