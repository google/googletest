...
tried <<how-am-i-supposed-to-make-sense-of-these-horrible-template-errors,Google Mock Doctor>> first.

== When I call a method on my mock object, the method for the real object is invoked instead. What's the problem?

In order for a method to be mocked, it must be _virtual_, unless you use the link:CookBook.adoc#mocking-nonvirtual-methods[high-perf dependency injection technique].
...
link:CookBook.adoc#writing-new-monomorphic-matchers[two]
link:CookBook.adoc#writing-new-polymorphic-matchers[recipes]
...
link:ForDummies.adoc#using-google-mock-with-any-testing-framework[Here] is how.
...
actions using
link:CookBook.adoc#writing-new-actions-quickly[MakeAction()] or
link:CookBook.adoc#writing-new-polymorphic-actions[MakePolymorphicAction()],
or you can write a stub function and invoke it using
link:CookBook.adoc#using-functionsmethodsfunctors-as-actions[Invoke()].
...
https://testing.googleblog.com/2008/06/defeat-static-cling.html[post]
...
See this link:CookBook.adoc#mocking-side-effects[recipe] for more details and an example.
...
. search the mailing list http://groups.google.com/group/googlemock/topics[archive],
. ask it on link:mailto:googlemock@googlegroups.com[googlemock@googlegroups.com] and someone will answer it (to prevent spam, we require you to join the http://groups.google.com/group/googlemock[discussion group] before you can post.).

Please note that creating an issue in the
https://github.com/google/googletest/issues[issue tracker] is _not_
